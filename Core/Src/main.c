...
float Fir_Output[4]={0};        //Fir滤波器滤波后的值
...
//	  allflag.CANFD_Tx_flag=CANFD_Send(0x10,3,encoder_str.Encoder_raw,0,pid_m1.Iq_current);
//	  pid_m1.Kp_i=0.0497626f/200*Iwidth;
//	  pid_m1.Ki_i=0.0047392f/200*Iwidth;
